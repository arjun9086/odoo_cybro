...
//    is_paid() {
//        const result = super.is_paid();
//        if (result && this._pending_discount) {
//            console.log("[Deducting] Session Discount Limit:", this._pending_discount);
//            remaining_discount_limit -= this._pending_discount;
//            this._pending_discount = 0;
//        }
//        return result;
//    },
    async finalizeValidation() {
        ...
        if (this._pending_discount) {
            console.log("[FINALIZE] Deducting discount after payment:", this._pending_discount);
            remaining_discount_limit -= this._pending_discount;
            this._pending_discount = 0;
        }
    },
